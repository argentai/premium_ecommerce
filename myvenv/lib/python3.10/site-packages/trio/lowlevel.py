...
from ._core import (Abort, ParkingLot, RunVar, Task, TrioToken, UnboundedQueue,
                    add_instrument, cancel_shielded_checkpoint, checkpoint,
                    checkpoint_if_cancelled, current_clock, current_root_task,
                    current_statistics, current_task, current_trio_token,
                    currently_ki_protected, disable_ki_protection,
                    enable_ki_protection, notify_closing,
                    permanently_detach_coroutine_object,
                    reattach_detached_coroutine_object, remove_instrument,
                    reschedule, spawn_system_task, start_guest_run,
                    start_thread_soon, temporarily_detach_coroutine_object,
...
if sys.platform == "win32":
    # Windows symbols
    from ._core import (current_iocp, monitor_completion_key,
