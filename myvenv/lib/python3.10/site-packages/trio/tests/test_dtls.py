...
from .._core.tests.tutil import binds_ipv6, gc_collect_harder, slow
...
async def test_server_socket_doesnt_crash_on_garbage(autojump_clock):
    ...
    from trio._dtls import (ContentType, HandshakeFragment, HandshakeType,
                            ProtocolVersion, Record, encode_handshake_fragment,
                            encode_record)
