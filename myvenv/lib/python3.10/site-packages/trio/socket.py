...
from ._socket import (SocketType, from_stdlib_socket, fromfd, getaddrinfo,
                      getnameinfo, getprotobyname,
                      set_custom_hostname_resolver, set_custom_socket_factory,
                      socket, socketpair)
...
from socket import (gaierror, gethostname, herror, htonl, htons, inet_aton,
                    inet_ntoa, inet_ntop, inet_pton, ntohs)
