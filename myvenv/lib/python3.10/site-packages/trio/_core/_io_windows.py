...
from ._windows_cffi import (INVALID_HANDLE_VALUE, AFDPollFlags,
                            CompletionModes, ErrorCodes, FileFlags,
                            IoControlCodes, WSAIoctls, _handle, ffi, kernel32,
                            ntdll, raise_winerror, ws2_32)
